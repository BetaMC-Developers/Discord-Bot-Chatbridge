...
public class DCBConfig extends Configuration {
    ...
    private void write() {
        ...
        //PEX Prefix Support
        generateConfigOption("pex-prefix-support.enabled", false);
        generateConfigOption("pex-prefix-support.info", "This option when enabled will display a users prefix from PermissionsEx in front of their name in chat when they send a message from Discord.");
